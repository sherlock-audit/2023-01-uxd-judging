...
## Found by 
kankodu, berndartmueller, unforgiven, yixxas, clems4ever, ck, HollaDieWaldfee, carrot, Zarf, chiranz, dipp, 0xNazgul, 0x52, GimelSec, ctf\_sec, Ruhum, DecorativePineapple, hl\_, koxuan, Bahurum
...
## Found by 
0xNazgul, 0x52, ctf\_sec, clems4ever
...
# Issue H-4: USDC deposited to PerpDepository.sol are irretrievable and effectively causes UDX to become undercollateralized 
...
# Issue H-5: PerpDepository#getPositionValue uses incorrect value for TWAP interval allowing more than intended funds to be extracted 
...
# Issue H-6: User specified slippage allows frontrunning 
...
## Found by 
berndartmueller, peanuts, HollaDieWaldfee, rvierdiiev, duc, yixxas, Bahurum
...
## Found by 
HonorLt, rvierdiiev, 0x52, GimelSec, yixxas, Bahurum
...
## Found by 
peanuts, hl\_, berndartmueller, HollaDieWaldfee
...
## Found by 
berndartmueller, cccz, Jeiwan, rvierdiiev, 0x52, GimelSec, koxuan, jprod15, CRYP70, Bahurum
...
## Found by 
berndartmueller, cccz, keccak123, peanuts, Jeiwan, rvierdiiev, 0x52, GimelSec
...
# Issue M-12: PerpDepository has no way to withdraw profits depriving stakers of profits owed 
...
# Issue M-13: PerpDepository.netAssetDeposits variable can prevent users to withdraw with underflow error 
