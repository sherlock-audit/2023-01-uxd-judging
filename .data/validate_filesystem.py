...
def main():
    ...
    def process_directory(path):
        ...
        items = [x for x in os.listdir(path) if x not in [".data", ".git", ".github", "README.md", "Audit_Report.pdf"]]
            ...
            if is_dir:
                ...
                if "-report" in item:
                    if not directory_has_report:
                        ...
                        errors.append("Directory %s has multiple best reports marked." % path)
